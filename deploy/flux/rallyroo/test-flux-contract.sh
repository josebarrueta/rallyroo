...
grep -q 'semver: ">=0.11.0 <0.12.0"' "$FLUX_DIR/source.yaml"
...
grep -q '^  name: rallyroo-family-data-encryption$' "$FLUX_DIR/onepassword-items.yaml"
grep -q '^  itemPath: vaults/rallyroo-prod/items/rallyroo-family-data-encryption$' "$FLUX_DIR/onepassword-items.yaml"
...
grep -q '^  name: rallyroo-google-routes$' "$FLUX_DIR/onepassword-items.yaml"
grep -q '^  itemPath: vaults/rallyroo-prod/items/rallyroo-google-routes$' "$FLUX_DIR/onepassword-items.yaml"
grep -q '^      googleRoutes: rallyroo-google-routes$' "$FLUX_DIR/release.yaml"
grep -q "rallyroo-google-routes) expected_keys='GOOGLE_ROUTES_API_KEY'" "$ENABLE_SCRIPT"
